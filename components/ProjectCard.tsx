  ...
  return (
    ...
    >
      <div className="flex flex-col relative z-0">
        ...
        {/* Image - снизу */}
        <div className="relative w-full px-4 sm:px-6 md:px-8 pb-4 sm:pb-6 md:pb-8">
          <div className="relative w-full h-[240px] sm:h-[280px] md:h-[380px] lg:h-[480px] overflow-hidden border border-gray-700/50 rounded-lg">
